...
def button_click(button_text, cost):
    ...
    if button_text == "fried rice":
        c.execute("UPDATE button_clicks SET cost=? WHERE button_text=?", (40, button_text))
    elif button_text == "chicken lolipop":
        c.execute("UPDATE button_clicks SET cost=? WHERE button_text=?", (35, button_text))
    elif button_text == "burger":
        c.execute("UPDATE button_clicks SET cost=? WHERE button_text=?", (55, button_text))
    elif button_text == "crispy chicken":
...
image_paths = ['windows/images/vfr.jpg', 'windows/images/cl.jpg', 'windows/images/b.jpg', 'windows/images/cc.jpeg']
...
# Define button names
button_info = [("fried rice", 40), ("Chicken lolipop", 35), ("Burger ", 55), ("crispy chicken", 45)]
